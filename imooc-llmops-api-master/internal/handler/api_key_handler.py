...
class ApiKeyHandler:
    ...
    async def update_api_key_is_active(self, api_key_id: UUID):
        """根据传递的信息更新API秘钥激活状态"""
        # 1.提取请求并校验
    ...
    async def get_api_keys_with_page(self):
