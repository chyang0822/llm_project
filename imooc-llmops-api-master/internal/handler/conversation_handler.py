...
class ConversationHandler:
    ...
    async def get_conversation_messages_with_page(self, conversation_id: UUID):
    ...
    async def delete_message(self, conversation_id: UUID, message_id: UUID):
    ...
    async def get_conversation_name(self, conversation_id: UUID):
        """根据传递的会话id获取指定会话的名字"""
        # 1.调用服务获取会话
    ...
    async def update_conversation_name(self, conversation_id: UUID):
    ...
    async def update_conversation_is_pinned(self, conversation_id: UUID):
