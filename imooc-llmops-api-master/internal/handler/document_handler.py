...
class DocumentHandler:
    ...
    async def get_document(self, dataset_id: UUID, document_id: UUID):
    ...
    async def update_document_name(self, dataset_id: UUID, document_id: UUID):
    ...
    async def update_document_enabled(self, dataset_id: UUID, document_id: UUID):
    ...
    async def delete_document(self, dataset_id: UUID, document_id: UUID):
    ...
    async def get_documents_with_page(self, dataset_id: UUID):
    ...
    async def get_documents_status(self, dataset_id: UUID, batch: str):
