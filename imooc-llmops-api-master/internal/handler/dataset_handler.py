...
class DatasetHandler:
    ...
    async def hit(self, dataset_id: UUID):
    ...
    async def get_dataset_queries(self, dataset_id: UUID):
    ...
    async def update_dataset(self, dataset_id: UUID):
        """根据传递的知识库id+信息更新知识库"""
        # 1.提取请求并校验
    ...
    async def get_datasets_with_page(self):
        """获取知识库分页+搜索列表数据"""
        # 1.提取query数据并校验
