...
class WebAppHandler:
    ...
    async def get_web_app(self, token: str):
    ...
    async def web_app_chat(self, token: str):
    ...
    async def stop_web_app_chat(self, token: str, task_id: UUID):
    ...
    async def get_conversations(self, token: str):
