...
class ApiToolHandler:
    ...
    async def get_api_tool_providers_with_page(self):
    ...
    async def create_api_tool_provider(self):
        """创建自定义API工具"""
    ...
    async def update_api_tool_provider(self, provider_id: UUID):
        """更新自定义API工具提供者信息"""
    ...
    async def get_api_tool(self, provider_id: UUID, tool_name: str):
    ...
    async def get_api_tool_provider(self, provider_id: UUID):
    ...
    async def delete_api_tool_provider(self, provider_id: UUID):
    ...
    async def validate_openapi_schema(self):
